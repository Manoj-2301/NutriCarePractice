    ...
    return (
        <div className='choose_wrapper'>
            ...
            <div className='choose_para'>
                <p className='choose_main_para'>Empowering Your Health Journey</p>
                <p className='choose_main_subpara'>Discover a holistic health management system designed for your lifestyle.Explore five key feature that <br />make staying healthy easier and smart</p>
            </div>
            <div>
                <div className='card'>
                    ...
                    <div>
                        ...
                        <div className='choose_card_three'>
                            <div>
                ...
                <div className='second_card'>
                    ...
                    <div className='card_second_row_two'>
                        <div>
